...
class _YoloConfig:
    ...
    def from_dict(d: dict) -> "_YoloConfig":
        return _YoloConfig(
            ...
            img_size=d.get("IMGSIZE", _YoloConfig.img_size),
            chunk_size=d.get("CHUNKSIZE", _YoloConfig.chunk_size),
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "AVAILABLEWEIGHTS": self.available_weights.to_list(),
            "CONF": self.conf,
            "IOU": self.iou,
...
class _GuiConfig:
    ...
    def from_dict(d: dict) -> "_GuiConfig":
        ...
        return _GuiConfig(
            ...
            font_size=d.get("FONTSIZE", _GuiConfig.font_size),
            window_config=window_config,
            frame_width=d.get("FRAMEWIDTH", _GuiConfig.frame_width),
            col_width=d.get("COLWIDTH", _GuiConfig.col_width),
        )

    def to_dict(self) -> dict:
        return {
            "OTC ICON": self.otc_icon,
            "FONT": self.font,
            "FONTSIZE": self.font_size,
            "WINDOW": self.window_config.to_dict(),
            "FRAMEWIDTH": self.frame_width,
            "COLWIDTH": self.col_width,
        }
...
class Config:
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "LAST PATHS": self.last_paths.to_dict(),
